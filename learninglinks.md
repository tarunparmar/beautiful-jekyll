...
* [Dean Attali's website is another great resource for learning](http://deanattali.com/blog/building-shiny-apps-tutorial/)

* [Interactive data visualization with Shiny](https://www.bioconductor.org/help/course-materials/2015/CSAMA2015/lab/shiny.html)

* [Introduction to R Graphics with ggplot2](http://tutorials.iq.harvard.edu/R/Rgraphics/Rgraphics.html)

* [Plotly is another great plotting library that provides some amount of interactivity, there is R and Python specific sections on their site](https://plot.ly/)
